...
/*
*使用串口数据结构体，用宏定义将这个库原来的接收缓冲区改为自己的接收缓冲区
*
*/
#include "usart_port.h"
extern USART_Data usartDebug;
#define g_usart_rx_sta usartDebug.usart_rx_sta
#define g_usart_rx_buf usartDebug.usart_rx_buf
