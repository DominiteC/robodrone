...
//-------------------------BMP280 校准参数-----------------------------------
static bmp280_calib_t bmp280_calib;  /* BMP280 出厂校准参数 (从芯片读取的补偿系数) */
//-------------------------BMP280 校准参数-----------------------------------

//-------------------------BMP280 驱动实例-----------------------------------
sDrv_BMP280_t bmp280;                /* BMP280 驱动实例 (含温度/气压/高度数据) */
//-------------------------BMP280 驱动实例-----------------------------------

//-------------------------BMP280 算法校准值-----------------------------------
int32_t t_fine;                      /* BMP280 温度补偿中间值 (用于气压/高度计算, 参考博世数据手册) */
//-------------------------BMP280 算法校准值-----------------------------------
