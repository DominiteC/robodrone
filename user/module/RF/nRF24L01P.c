...
//-------------------------nRF24L01P CE 引脚状态-----------------------------------
static INT8U CE_Status = 0;  /* nRF24L01P CE 引脚电平状态 (0=LOW, 1=HIGH) */
//-------------------------nRF24L01P CE 引脚状态-----------------------------------
/*!
================================================================================
------------------------------------Functions-----------------------------------
...
void L01_SetDataRate(L01_DRATE drate)
{
    ...
    {
        /* 1Mbps requires both rate bits cleared */
    }
...
void L01_Init(void)
{
    ...
    INT8U tx_addr[5] = {TX_ADDR};
    INT8U rx_addr[5] = {RX_ADDR};
    ...
    L01_WriteSingleReg(L01REG_SETUP_RETR,ARD_4000US|ARC_5);//ARD:4000us,repeat time:5
    L01_SetDataRate(DRATE_250K);
    L01_WriteHoppingPoint(100);
    L01_SetPower(POWER_N_0);
    L01_SetTXAddr(addr,5);//Set TX address
    L01_SetRXAddr(0,addr,5);//Set RX address
    // L01_SetRXAddr(1,rx_addr,5);//Set RX address
}
